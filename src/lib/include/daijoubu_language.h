...
namespace DAIJOUBU {
	...
	static const size_t DAIJOUBU_TOKEN_SUBTYPE_LEN[] = {
		...
		(DAIJOUBU_OPERATOR_SIMPLE_MAX + 1), 0, 0, 0, (DAIJOUBU_SYMBOL_MAX + 1), 
		(DAIJOUBU_SYMBOL_SIMPLE_MAX + 1), (DAIJOUBU_TYPE_MAX + 1),
		};
	...
	static const std::wstring *DAIJOUBU_TOKEN_SUBTYPE_STRS[] = {
		...
		NULL, NULL, NULL, DAIJOUBU_SYMBOL_STR, DAIJOUBU_SYMBOL_SIMPLE_STR, 
		DAIJOUBU_TYPE_STR,
		};
