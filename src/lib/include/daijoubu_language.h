...
namespace DAIJOUBU {
	...
	#define DAIJOUBU_TYPE_SPECIAL_FOLLOW DAIJOUBU_CHARACTER(L'\'')
	#define DAIJOUBU_TYPE_SPECIAL_POINTER DAIJOUBU_CHARACTER(L'*')
	#define DAIJOUBU_UNDERSCORE_MAX_POSITION 2
	...
	typedef enum {
		...
		DAIJOUBU_TOKEN_END,
		DAIJOUBU_TOKEN_EXPRESSION,
		DAIJOUBU_TOKEN_EXPRESSION_LIST,
		...
		DAIJOUBU_TOKEN_PARAMETER,
		DAIJOUBU_TOKEN_PARAMETER_LIST,
		DAIJOUBU_TOKEN_STATEMENT,
		DAIJOUBU_TOKEN_STATEMENT_LIST,
	...
	static const std::wstring DAIJOUBU_TOKEN_STR[] = {
		L"BEGIN", L"CONSTANT", L"CONTROL", L"END", L"EXPRESSION", L"EXPRESSION_LIST", 
		L"IDENTIFIER", L"BOOLEAN", L"NUMERIC", L"STRING", L"MODIFIER", L"NATIVE", 
		L"OPERATOR", L"OPERATOR", L"PARAMETER", L"PARAMETER_LIST", L"STATEMENT", 
		L"STATEMENT_LIST", L"SUBSCRIPT", L"SUPERSCRIPT", L"SYMBOL", L"SYMBOL", L"TYPE",
		};
	...
	static const size_t DAIJOUBU_TOKEN_SUBTYPE_LEN[] = {
		0, (DAIJOUBU_CONSTANT_MAX + 1), (DAIJOUBU_CONTROL_MAX + 1), 0, 0, 0, 0,
		(DAIJOUBU_LITERAL_BOOLEAN_MAX + 1), 0, 0, (DAIJOUBU_MODIFIER_MAX + 1), 
		(DAIJOUBU_NATIVE_MAX + 1), (DAIJOUBU_OPERATOR_MAX + 1), 
		(DAIJOUBU_OPERATOR_SIMPLE_MAX + 1), 0, 0, (DAIJOUBU_STATEMENT_MAX + 1), 
		0, 0, 0, (DAIJOUBU_SYMBOL_MAX + 1), (DAIJOUBU_SYMBOL_SIMPLE_MAX + 1), 
		(DAIJOUBU_TYPE_MAX + 1),
		};
	...
	static const std::wstring *DAIJOUBU_TOKEN_SUBTYPE_STRS[] = {
		NULL, DAIJOUBU_CONSTANT_STR, DAIJOUBU_CONTROL_STR, NULL, NULL, NULL, NULL,
		...
		NULL, NULL, DAIJOUBU_STATEMENT_STR, NULL, NULL, NULL, DAIJOUBU_SYMBOL_STR, 
