...
namespace DAIJOUBU {
	...
	static const std::wstring DAIJOUBU_TOKEN_STR[] = {
		...
		L"NUMERIC", L"STRING", L"MODIFIER", L"OPERATOR", L"OPERATOR",
		L"SUBSCRIPT", L"SUPERSCRIPT", L"SYMBOL", L"SYMBOL", L"TYPE",
		};
	...
	static const size_t DAIJOUBU_TOKEN_SUBTYPE_LEN[] = {
		...
		(DAIJOUBU_OPERATOR_MAX + 1), (DAIJOUBU_OPERATOR_SIMPLE_MAX + 1), 0, 0, 
	...
	static const std::wstring *DAIJOUBU_TOKEN_SUBTYPE_STRS[] = {
		...
		DAIJOUBU_OPERATOR_STR, DAIJOUBU_OPERATOR_SIMPLE_STR, NULL, NULL, 
		DAIJOUBU_SYMBOL_STR, DAIJOUBU_SYMBOL_SIMPLE_STR, DAIJOUBU_TYPE_STR,
		};
