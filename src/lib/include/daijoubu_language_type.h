...
namespace DAIJOUBU {
	...
	namespace LANGUAGE {
		...
		enum {
			DAIJOUBU_LANGUAGE_EXCEPTION_INVALID_FLOAT = 0,
		...
		#define DAIJOUBU_LANGUAGE_EXCEPTION_MAX DAIJOUBU_LANGUAGE_EXCEPTION_MALFORMED_FLOAT

		static const std::wstring DAIJOUBU_LANGUAGE_EXCEPTION_STR[] = {
			DAIJOUBU_LANGUAGE_EXCEPTION_HEADER L" Invalid floating-point value",
			DAIJOUBU_LANGUAGE_EXCEPTION_HEADER L" Invalid radix character",
			DAIJOUBU_LANGUAGE_EXCEPTION_HEADER L" Invalid radix",
			DAIJOUBU_LANGUAGE_EXCEPTION_HEADER L" Malformed floating-point value",
			};
