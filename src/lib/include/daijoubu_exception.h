...
namespace DAIJOUBU {
	...
	typedef enum {
		...
		DAIJOUBU_REGION_LANGUAGE,
		DAIJOUBU_REGION_LEXER,
		DAIJOUBU_REGION_LIBRARY,
		DAIJOUBU_REGION_NODE,
		DAIJOUBU_REGION_PARSER,
		DAIJOUBU_REGION_TOKEN,
		DAIJOUBU_REGION_UID,
		DAIJOUBU_REGION_UNICODE,
	} daijoubu_region_t;

	#define DAIJOUBU_REGION_MAX DAIJOUBU_REGION_UNICODE

	static const std::wstring DAIJOUBU_REGION_STR[] = {
		L"NONE", L"LANGUAGE", L"LEXER", L"LIBRARY", L"NODE", L"PARSER", L"TOKEN", 
		L"UID", L"UNICODE",
		};
