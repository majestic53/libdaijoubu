...
namespace DAIJOUBU {
	...
	namespace LANGUAGE {
		...
		static const std::wstring DAIJOUBU_PARSER_EXCEPTION_STR[] = {
			...
			DAIJOUBU_PARSER_EXCEPTION_HEADER L" Expecting content block",
			DAIJOUBU_PARSER_EXCEPTION_HEADER L" Expecting control structure",
			DAIJOUBU_PARSER_EXCEPTION_HEADER L" Expecting elif control structure",
			DAIJOUBU_PARSER_EXCEPTION_HEADER L" Expecting else control structure",
