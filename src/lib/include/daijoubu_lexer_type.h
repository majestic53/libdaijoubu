...
namespace DAIJOUBU {
	...
	namespace LANGUAGE {
		...
		enum {
			DAIJOUBU_LEXER_EXCEPTION_INVALID_DIALECT = 0,
		...
		#define DAIJOUBU_LEXER_EXCEPTION_MAX DAIJOUBU_LEXER_EXCEPTION_UNTERMINATED_COMMENT

		static const std::wstring DAIJOUBU_LEXER_EXCEPTION_STR[] = {
			DAIJOUBU_LEXER_EXCEPTION_HEADER L" Character dialect mismatch",
