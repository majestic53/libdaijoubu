...
namespace DAIJOUBU {
	...
	namespace LANGUAGE {
		...
		static const std::wstring DAIJOUBU_LEXER_EXCEPTION_STR[] = {
			...
			DAIJOUBU_LEXER_EXCEPTION_HEADER L" Expecting number",
			...
			DAIJOUBU_LEXER_EXCEPTION_HEADER L" Invalid number",
			...
			DAIJOUBU_LEXER_EXCEPTION_HEADER L" Unsupported radix",
			DAIJOUBU_LEXER_EXCEPTION_HEADER L" Unsupported symbol",
